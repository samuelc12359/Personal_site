...
$\color{MidnightBlue}{\textbf{Machine Learning Project}}$$\qquad$$\qquad$ $\qquad$$\qquad$$\qquad$$\qquad$$\qquad$$\qquad$ Fall 2020
...
$\color{MidnightBlue}{\textbf{Exploratory analysis}}$ $\qquad$$\qquad$$\qquad$$\qquad$$\qquad$$\qquad$$\qquad$$\qquad$$\qquad$ Fall 2019
...
- Created cloroplath map of MLB stadium locations using longitude and latitude data
